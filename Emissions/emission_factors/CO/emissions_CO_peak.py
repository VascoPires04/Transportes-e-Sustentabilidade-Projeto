...
fatores_emissao = {
    'Car_Petrol': 8.846014608/1000/1.6,          # Real
    'Car_Diesel': 0.182530014/1000/1.6,          # Real
    'Car_LPG': 1.408318597/1000/1.6,             # Real
    'Bus': 2.508220947/1000/20.3,          # Real
    'Motorbike': 8.846014608/1000/1.6,           # Real
    'Walk': 0.0,
    'Bike': 0.0,
    'Rail': 0,                                   # Exemplo
    'Metro': 0,                                  # Exemplo
    'Ferry': 0,                                  # Exemplo
    'Taxi':  0.182530014/1000/1.6,               # Real
    'Carpool':  0.182530014/1000/2,              # Real
    'IST Shuttle':  0.182530014/1000/1.6         # Real
}
...
print(f"\nEmissões Totais Antes: {round(emissoes_totais_antes, 2)} kg CO (peak)")
print(f"Emissões Totais Depois: {round(emissoes_totais_depois, 2)} kg CO (peak)")
print(f"Redução de Emissões: {round(reducao_emissoes, 2)} kg CO (peak)")
