...
fatores_emissao = {
    'Car_Petrol': 1080.3004514830002/1000/1.6,    # Real
    'Car_Diesel': 212.224015861/1000/1.6,         # Real
    'Car_LPG': 185.811925103/1000/1.6,            # Real
    'Bus': 1141.4086294429999/1000/1.6,           # Real
    'Motorbike': 1080.3004514830002/1000/1.6,     # Real
    'Walk': 0.0,
    'Bike': 0.0,
    'Rail': 25.8/1000,                            # Exemplo
    'Metro': 38.6/1000,                            # Exemplo
    'Ferry': 0.23,                                 # Exemplo
    'Taxi': 212.224015861/1000/1.6,               # Real
    'Carpool': 212.224015861/1000/2,              # Real
    'IST Shuttle': 212.224015861/1000/1.6         # Real
}
...
# Função para calcular emissões antes da mudança
...
# Função para calcular emissões após a mudança
...
print(f"\nEmissões Totais Antes: {round(emissoes_totais_antes, 2)} kg CO2e (gases de estufa) (peak)")
print(f"Emissões Totais Depois: {round(emissoes_totais_depois, 2)} kg CO2e (gases de estufa) (peak)")
print(f"Redução de Emissões: {round(reducao_emissoes, 2)} kg CO2e (gases de estufa) (peak)")
